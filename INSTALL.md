...
If you do not want to install git, you can instead download [master.zip](https://github.com/austinkeller/handson-ml2/archive/ml-guild-book-club.zip), unzip it, rename the resulting directory to `handson-ml2` and move it to your development directory.
